...
typedef enum
{
    ...
    APP_LOAD_CELL_RATED_OUTPUT_LOAD_IN_KGS_ATTR_ID = 7500,
    APP_LOAD_CELL_ZERO_BALANCE_FIGURE_ATTR_ID = 7501,
    APP_LOAD_CELL_SERIAL_NR_ATTR_ID = 7502,
    APP_LOAD_CELL_SENSITIVITY_IN_UV_PER_V_ATTR_ID = 7503,
    APP_LOAD_CELL_NOMINAL_LOAD_IN_KGS_ATTR_ID = 7504
